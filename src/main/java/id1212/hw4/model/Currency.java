...
public class Currency implements Serializable {
    ...
    public String convert(String toCurrency, int amount) {
        ...
        switch (toCurrency) {
            case "EUR":
                result = calculateConversion(EUR, amount);
                break;
            ...
            case "GBP":
                result = calculateConversion(GBP, amount);
                break;
            ...
            case "SEK":
                result = calculateConversion(SEK, amount);
                break;
            ...
            case "USD":
                result = calculateConversion(USD, amount);
                break;
            ...
            case "RMB":
                result = calculateConversion(RMB, amount);
                break;
    ...
    public String toString() {
        return "id1212.hw4.model.Currency[ src=" + src + " ]";
    }
